...
| `2026-05-03_mlx-chat-contract-cleanup` | active | `feature/mlx-chat-contract-cleanup` | `Acer-HL` | backend local | `iMac-Debian` / `testing/initiatives/...` | provider seam landed |
