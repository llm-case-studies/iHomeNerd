...
| `2026-05-03_mlx-chat-contract-cleanup` | active | `feature/iphone-to-mac-brain/mlx-chat-contract-cleanup` | `Acer-HL` | backend local | `iMac-Debian` / `testing/initiatives/...` | provider seam landed |
...
There are two first-lane sprints:

- `2026-05-03_ios-mac-setup-route-smoke` closes the nearest iPhone evidence gap
  on the Mac/iPhone build lane.
- `2026-05-03_mlx-chat-contract-cleanup` is the first OpenCode-ready product
  sprint for `Acer-HL`; it cleans up the backend contract before more Mac brain
  promotion work depends on it.
